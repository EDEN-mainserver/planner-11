  ...
  "slides": [
    {
      "num": 1,
      "part": "표지|본문|마무리",
      "headline": "표지(part=표지)는 반드시 두 부분으로 작성: 첫 줄은 짧은 후크 문장(질문형/공감형, 1줄·15~25자), 줄바꿈(\\n), 둘째 줄은 메인 카피(단정형/약속형, **반드시 22자 이하, 2줄 이내에 의미가 완결**되어야 함. 22자 넘으면 짧게 다듬어서 짧게 끝낼 것). 본문·마무리는 한 문장 카피 1~1.5문장(30~55자). 모두 타겟의 결핍을 자극. 단어 중간 자르기 금지. **표지 headline에는 브랜드명·제품명·계정명을 절대 포함하지 말 것 (브랜드명은 표지 상단/하단 라벨에 자동으로 들어감 — 본 카피 자리에 다시 넣으면 중복되어 디자인이 망가짐). 예: \"CLAUDEMASTER\", \"클로드마스터\" 같은 브랜드 단독 문장 금지.** 예시: \"지금 클로드, 아직도 질문만 던지세요?\\n클로드 과외 기능, 따로 있습니다\"",
